    ...
    return (
        <div className='max-w-[1400px] m-auto py-16 px-4 grid lg:grid-cols-2 gap-4'>
            ...
            <div className='flex flex-col h-full justify-center'>
                <h2 className='text-5xl md:text-6xl font-bold'>Plan Your Next Trip</h2>
                <p className='text-2xl py-6'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quidem, nam.</p>
                <p className='pb-6'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aliquid enim temporibus aliquam, quis ab labore error, minima eum repudiandae quisquam dolorum ex ipsa ipsum! Ratione sapiente soluta suscipit ipsum? Obcaecati.</p>
                <div>
